...
function M.get(theme, colors, opts)
  ...
  return {
    ...
    ["@variable.parameter"]  = { fg = theme.base0A },
    ["@variable.member"]     = { fg = theme.base08 },
    ["@variable.member.key"] = { fg = theme.base08 },

    ["@module"]              = { fg = theme.base08 },

    ["@boolean"]             = { fg = theme.base0A },
    ["@constant"]            = { fg = theme.base0A },
    ["@constant.builtin"]    = { fg = theme.base0A },
    ...
    ["@constructor"]           = { fg = theme.base08 },

    ["@operator"]              = { fg   = theme.base05  },
    ["@reference"]             = { fg   = theme.base05  },
    ["@punctuation.bracket"]   = { fg   = theme.base0C  },
    ["@punctuation.delimiter"] = { fg   = theme.base0C  },
    ...
    ["@markup.quote"]          = { bg = opts.transparency and nil or colors.black2 },

    ["@comment"]               = { fg = colors.light_grey },
    ["@comment.todo"]          = { fg = colors.grey_fg,bg = colors.white },
